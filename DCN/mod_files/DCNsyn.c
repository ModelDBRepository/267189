...
#define nrn_init _nrn_init__DCNsyn
#define _nrn_initial _nrn_initial__DCNsyn
#define nrn_cur _nrn_cur__DCNsyn
#define _nrn_current _nrn_current__DCNsyn
#define nrn_jacob _nrn_jacob__DCNsyn
#define nrn_state _nrn_state__DCNsyn
#define _net_receive _net_receive__DCNsyn 
#define state state__DCNsyn 
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 pnt_receive_size[_mechtype] = 1;
 	...
 	ivoc_help("help ?1 DCNsyn D:/NEURON models/DCN LuthmanEtAl2011 Stimulation Ef/mod_files/DCNsyn.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "DCNsyn.mod";
static const char* nmodl_file_text = 
