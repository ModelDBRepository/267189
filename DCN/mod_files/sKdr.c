...
#define nrn_init _nrn_init__sKdr
#define _nrn_initial _nrn_initial__sKdr
#define nrn_cur _nrn_cur__sKdr
#define _nrn_current _nrn_current__sKdr
#define nrn_jacob _nrn_jacob__sKdr
#define nrn_state _nrn_state__sKdr
#define _net_receive _net_receive__sKdr 
#define _f_rate _f_rate__sKdr 
#define rate rate__sKdr 
#define states states__sKdr 
...
#define qdeltat qdeltat_sKdr
 double qdeltat = 1;
#define usetable usetable_sKdr
 double usetable = 1;
 ...
 "qdeltat_sKdr", &qdeltat_sKdr,
 "usetable_sKdr", &usetable_sKdr,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 sKdr D:/NEURON models/DCN LuthmanEtAl2011 Stimulation Ef/mod_files/sKdr.mod\n");
...
static int _reset;
static char *modelname = "Slow delayed rectifier (sKdr) of deep cerebellar nucleus (DCN) neuron";
...
static int  _f_rate ( _threadargsprotocomma_ double _lv ) {
   minf = 1.0 / ( 1.0 + exp ( ( _lv + 50.0 ) / - 9.1 ) ) ;
   taum = 14.95 / ( exp ( ( _lv + 50.0 ) / 21.74 ) + exp ( ( _lv + 50.0 ) / - 13.91 ) ) + 0.05 ;
   taum = taum / qdeltat ;
    return 0; }
...
#if NMODL_TEXT
static const char* nmodl_filename = "sKdr.mod";
static const char* nmodl_file_text = 
