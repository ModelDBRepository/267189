...
#define nrn_init _nrn_init__DCNsynNMDA
#define _nrn_initial _nrn_initial__DCNsynNMDA
#define nrn_cur _nrn_cur__DCNsynNMDA
#define _nrn_current _nrn_current__DCNsynNMDA
#define nrn_jacob _nrn_jacob__DCNsynNMDA
#define nrn_state _nrn_state__DCNsynNMDA
#define _net_receive _net_receive__DCNsynNMDA 
#define state state__DCNsynNMDA 
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 pnt_receive_size[_mechtype] = 1;
 	...
 	ivoc_help("help ?1 DCNsynNMDA D:/NEURON models/DCN LuthmanEtAl2011 Stimulation Ef/mod_files/DCNsynNMDA.mod\n");
...
static double _nrn_current(double* _p, Datum* _ppvar, Datum* _thread, _NrnThread* _nt, double _v){double _current=0.;v=_v;{ {
   C = 1.0 / ( 1.0 + MgFactor * exp ( - gamma * v ) ) ;
   g = ( B - A ) * C ;
   i = g * ( v - e ) ;
   }
 _current += i;
...
#if NMODL_TEXT
static const char* nmodl_filename = "DCNsynNMDA.mod";
static const char* nmodl_file_text = 
