...
#define nrn_init _nrn_init__CaConc
#define _nrn_initial _nrn_initial__CaConc
#define nrn_cur _nrn_cur__CaConc
#define _nrn_current _nrn_current__CaConc
#define nrn_jacob _nrn_jacob__CaConc
#define nrn_state _nrn_state__CaConc
#define _net_receive _net_receive__CaConc 
#define states states__CaConc 
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "setdata_CaConc", _hoc_setdata,
 0, 0
};
 /* declare global and static user variables */
#define caiBase caiBase_CaConc
 double caiBase = 5e-05;
#define tauCa tauCa_CaConc
 double tauCa = 70;
 ...
 "tauCa_CaConc", &tauCa_CaConc,
 "caiBase_CaConc", &caiBase_CaConc,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 CaConc D:/NEURON models/DCN LuthmanEtAl2011 Stimulation Ef/mod_files/CaConc.mod\n");
...
static int _reset;
static char *modelname = "Intracellular calcium concentration in deep cerebellar nucleus (DCN) neuron";
...
#if NMODL_TEXT
static const char* nmodl_filename = "CaConc.mod";
static const char* nmodl_file_text = 
