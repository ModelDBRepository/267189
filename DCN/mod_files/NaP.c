...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 NaP D:/NEURON models/DCN LuthmanEtAl2011 Stimulation Ef/mod_files/NaP.mod\n");
...
static int _reset;
static char *modelname = "Persistent sodium current (NaP) of deep cerebellar nucleus (DCN) neuron";
