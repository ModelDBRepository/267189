...
#define nrn_init _nrn_init__pasDCN
#define _nrn_initial _nrn_initial__pasDCN
#define nrn_cur _nrn_cur__pasDCN
#define _nrn_current _nrn_current__pasDCN
#define nrn_jacob _nrn_jacob__pasDCN
#define nrn_state _nrn_state__pasDCN
#define _net_receive _net_receive__pasDCN 
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_prop_size(_mechtype, 5, 0);
 	...
 	ivoc_help("help ?1 pasDCN D:/NEURON models/DCN LuthmanEtAl2011 Stimulation Ef/mod_files/pasDCN.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "pasDCN.mod";
static const char* nmodl_file_text = 
  "COMMENT\n"
