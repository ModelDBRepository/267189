...
#define nrn_init _nrn_init__fKdr
#define _nrn_initial _nrn_initial__fKdr
#define nrn_cur _nrn_cur__fKdr
#define _nrn_current _nrn_current__fKdr
#define nrn_jacob _nrn_jacob__fKdr
#define nrn_state _nrn_state__fKdr
#define _net_receive _net_receive__fKdr 
#define _f_rate _f_rate__fKdr 
#define rate rate__fKdr 
#define states states__fKdr 
...
#define qdeltat qdeltat_fKdr
 double qdeltat = 1;
#define usetable usetable_fKdr
 double usetable = 1;
 ...
 "qdeltat_fKdr", &qdeltat_fKdr,
 "usetable_fKdr", &usetable_fKdr,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 fKdr D:/NEURON models/DCN LuthmanEtAl2011 Stimulation Ef/mod_files/fKdr.mod\n");
...
static int _reset;
static char *modelname = "Fast delayed rectifier (fKdr) of deep cerebellar nucleus (DCN) neuron";
...
static int  _f_rate ( _threadargsprotocomma_ double _lv ) {
   minf = 1.0 / ( 1.0 + exp ( ( _lv + 40.0 ) / - 7.8 ) ) ;
   taum = 13.9 / ( exp ( ( _lv + 40.0 ) / 12.0 ) + exp ( ( _lv + 40.0 ) / - 13.0 ) ) + 0.1 ;
   taum = taum / qdeltat ;
    return 0; }
...
#if NMODL_TEXT
static const char* nmodl_filename = "fKdr.mod";
static const char* nmodl_file_text = 
